                                            ...
                                            <div class="space-y-1 text-right">
                                                ...
                                                <div class="relative flex items-center justify-end gap-1">
                                                    <select name="tampilkan_motorik" 
                                                        ...
                                                        <option value="Tidak" selected>SEMBUNYIKAN</option>
                                                    </select>
                            ...
                            <tr>
                                ...
                                <td class="space-y-4">
                                    <textarea name="pemeriksaan_fisik_manual" rows="2"
                                        ...
                                        class="w-full bg-white border border-gray-400 rounded-xl px-4 py-3 text-xs font-black text-brand-darkblue focus:border-brand-blue outline-none resize-none"></textarea>
                                    <div class="flex items-center gap-4">
                                        ...
                                        <label class="flex items-center gap-2 cursor-pointer group">
                                            <input type="radio" name="tampilkan_fisik" value="Tidak" checked
                                                class="w-4 h-4 text-brand-blue focus:ring-brand-blue border-gray-300">
                            ...
                            <tr>
                                ...
                                <td class="space-y-4">
                                    ...
                                    <div class="flex items-center gap-4">
                                        ...
                                        <label class="flex items-center gap-2 cursor-pointer group">
                                            <input type="radio" name="tampilkan_penunjang" value="Tidak" checked
                                                class="w-4 h-4 text-brand-blue focus:ring-brand-blue border-gray-300">
                                            <span class="text-[10px] font-bold text-gray-700 group-hover:text-brand-blue">TIDAK</span>
                                        </label>
                                    </div>
