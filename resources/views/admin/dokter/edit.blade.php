...
<head>
    ...
    <title>Edit Dokter - RSUD dr. Soeratno Gemolong</title>
    ...
    <main class="flex-1 flex flex-col overflow-hidden relative">
        <header
            ...
            <div class="flex items-center gap-3 lg:gap-4 flex-1">
                ...
                <div class="truncate">
                    <h2 class="text-sm lg:text-2xl font-black text-brand-darkblue tracking-tight truncate">Edit Data
                        Dokter</h2>
                    <p class="text-[8px] lg:text-xs text-gray-500 font-medium truncate uppercase tracking-widest">
                        Perbarui informasi tenaga medis</p>
                </div>
            </div>
        ...
        <div class="flex-1 overflow-y-auto p-10">
            <div class="max-w-2xl mx-auto">
                <form action="{{ url('/admin/data-dokter/update/' . $dokter->id) }}" method="POST"
                    ...
                    <div class="p-10 space-y-6">
                        ...
                        <div>
                            ...
                            <input type="text" name="jabatan" value="{{ $dokter->jabatan }}"
                                placeholder="Contoh: Kepala Bidang Pelayanan"
                                class="w-full bg-white border border-gray-200 rounded-xl px-4 py-3 font-bold text-brand-darkblue focus:ring-4 focus:ring-brand-blue/10 focus:border-brand-blue transition-all outline-none">
                        </div>
                        ...
                        <div class="pt-6">
                            <button type="submit"
                                class="w-full bg-brand-blue text-white py-4 rounded-2xl font-black uppercase tracking-widest shadow-lg shadow-brand-blue/20 hover:bg-brand-darkblue transition-all duration-300">UPDATE
                                DATA DOKTER</button>
                        </div>
                    </div>
                </form>
