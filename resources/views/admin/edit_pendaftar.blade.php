...
@section('content')
        ...
        <div class="flex items-center gap-3 lg:gap-4 flex-1">
            ...
            <div class="truncate">
                ...
                <p class="text-[8px] lg:text-xs text-brand-gray font-medium truncate uppercase tracking-widest mt-0.5">
                    Perbarui informasi pasien terdaftar</p>
            </div>
        </div>
    ...
    <div class="flex-1 overflow-y-auto p-4 lg:p-10 bg-[#fbfcfd]">
        <div class="max-w-4xl mx-auto">
            <form action="{{ url('/admin/data-pendaftar/update/' . $pendaftar->id) }}" method="POST"
                ...
                @csrf
                @include('admin.partials.pendaftar_fields', ['pendaftar' => $pendaftar])
            </form>
        </div>
    </div>
@endsection