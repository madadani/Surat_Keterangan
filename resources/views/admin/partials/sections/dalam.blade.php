<!-- Section: POLI DALAM -->
<tbody id="section_dalam" class="hidden animate__animated animate__fadeIn">
    <tr class="border-t border-gray-100">
        <td colspan="3" class="pt-10 pb-4">
            <div class="flex items-center gap-4">
                <h3 class="text-sm font-black text-brand-blue uppercase tracking-widest">Pemeriksaan Poli Dalam</h3>
    ...
    <tr>
        ...
        <td class="flex items-center gap-4">
            <div class="flex-1 space-y-1.5">
                ...
                <input type="number" name="tinggi_badan_dalam" id="tinggi_dalam_input"
            ...
            <div class="flex-1 space-y-1.5">
                ...
                <input type="number" step="0.1" name="berat_badan_dalam" id="berat_dalam_input"
                    class="w-full bg-white border border-gray-400 rounded-xl px-4 py-3 text-xs font-black text-brand-darkblue focus:border-brand-blue">
            </div>
            <div class="flex-1 space-y-1.5">
                <label class="text-[9px] font-black text-gray-400 uppercase tracking-tighter">BMI (IMT)</label>
                <input type="text" name="bmi_dalam" id="bmi_dalam_input" placeholder="Auto"
                    class="w-full bg-white border border-gray-400 rounded-xl px-4 py-3 text-xs font-black text-brand-darkblue focus:border-brand-blue">
            </div>
        </td>
    </tr>
    <tr>
        ...
        <td class="grid grid-cols-2 lg:grid-cols-4 gap-4">
            <div class="space-y-1.5">
                ...
                <input type="text" name="tensi_dalam"
        ...
        <td class="space-y-4">
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-4">
                <div class="space-y-1.5">
                    ...
                    <div class="flex items-center gap-4 mt-2">
                        <label class="flex items-center gap-2 cursor-pointer group">
                            <input type="radio" name="gangguan_motorik_dalam" value="Ada"
                        ...
                        <label class="flex items-center gap-2 cursor-pointer group">
                            <input type="radio" name="gangguan_motorik_dalam" value="Tidak" checked
                                class="w-4 h-4 text-brand-blue focus:ring-brand-blue border-gray-300">
                ...
                <div class="space-y-1.5">
                    ...
                    <div class="flex items-center gap-4 mt-2">
                        <label class="flex items-center gap-2 cursor-pointer group">
                            <input type="radio" name="disabilitas_dalam" value="Ada"
                                class="w-4 h-4 text-brand-blue focus:ring-brand-blue border-gray-300">
                            <span class="text-xs font-bold text-gray-700 group-hover:text-brand-blue">ADA</span>
                        </label>
                        <label class="flex items-center gap-2 cursor-pointer group">
                            <input type="radio" name="disabilitas_dalam" value="Tidak" checked
                                class="w-4 h-4 text-brand-blue focus:ring-brand-blue border-gray-300">
                            <span class="text-xs font-bold text-gray-700 group-hover:text-brand-blue">TIDAK</span>
                        </label>
                    </div>
            ...
            <div class="space-y-1.5">
                ...
                <input type="text" name="keterangan_lainnya_dalam" placeholder="Catatan tambahan (opsional)..."
                    class="w-full bg-white border border-gray-400 rounded-xl px-4 py-3 text-xs font-black text-brand-darkblue focus:border-brand-blue">
            </div>
        </td>
    </tr>
