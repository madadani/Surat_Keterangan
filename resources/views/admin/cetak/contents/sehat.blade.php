...
<div class="content">
    ...
    <div class="field-container">
        ...
        <div class="field">
            ...
            <span class="value">
                Gangguan Motorik :
                {{ isset($surat->mcu_data['gangguan_motorik']) ? strtoupper($surat->mcu_data['gangguan_motorik']) : '-' }}<br>
                Disabilitas :
                {{ isset($surat->mcu_data['disabilitas']) ? strtoupper($surat->mcu_data['disabilitas']) : '-' }}
