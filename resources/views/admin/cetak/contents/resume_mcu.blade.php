...
<div class="content" style="font-family: Arial, sans-serif; font-size: 11pt;">
    ...
    <table style="width: 100%; border: 1px solid #000; border-collapse: collapse; margin-bottom: 10px;">
        <tr>
            ...
            <td style="border: 1px solid #000; padding: 4px; width: 30%;">: {{ $resmcu['bmi'] ?? '-' }} kg/m2</td>
        </tr>
        <tr>
    ...
    <table style="width: 100%; border: 1px solid #000; border-collapse: collapse; margin-bottom: 15px;">
        <tr>
            ...
            <td style="border: 1px solid #000; padding: 4px; width: 30%;">: {{ $resmcu['diastolic'] ?? '-' }} mmHg</td>
        </tr>
        <tr>
    ...
    <table style="width: 100%; border: 1px solid #000; border-collapse: collapse; margin-bottom: 15px;">
        <tr>
            ...
            <td style="border: 1px solid #000; padding: 4px; width: 25%;">: {{ $resmcu['visus_od_dengan'] ?? '-' }}</td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td colspan="3" style="border: 1px solid #000; padding: 4px;">: {{ $resmcu['buta_warna'] ?? 'Tidak' }}</td>
        </tr>
    </table>
    ...
    <table style="width: 100%; border: 1px solid #000; border-collapse: collapse; margin-bottom: 15px;">
        ...
        @foreach($sup_pairs as $pair)
            ...
            <tr>
                ...
                <td style="border: 1px solid #000; padding: 4px; width: 30%;">: {{ $resmcu['sup_' . $k1] ?? 'Normal' }}</td>
                <td style="border: 1px solid #000; padding: 4px; width: 20%;">{{ $v2 }}</td>
                <td style="border: 1px solid #000; padding: 4px; width: 30%;">: {{ $resmcu['sup_' . $k2] ?? 'Normal' }}</td>
            </tr>
        @endforeach
    </table>
    ...
    <div>
        ...
        <p>JANTUNG DAN SISTEM KARDIOVASKULAR : <span
                style="border-bottom: 1px dotted #000;">{{ $resmcu['vis_kardiovaskular'] ?? 'Normal' }}</span></p>
    ...
    @endphp
    <table style="width: 100%; border: 1px solid #000; border-collapse: collapse; font-size: 8px; text-align: center;">
        ...
        <tr>
            ...
            @foreach(['M3', 'M2', 'M1', 'P2', 'P1', 'C', 'I2', 'I1', 'I1', 'I2', 'C', 'P1', 'P2', 'M1', 'M2', 'M3'] as $p)
                ...
                <td style="border: 1px solid #000;">{{ getGigi($resmcu['matrix_atas'] ?? '', $p, $occ_map[$p]) }}</td>
            @endforeach
        </tr>
        <!-- Gigi Bawah -->
        <tr>
            ...
            @foreach(['M3', 'M2', 'M1', 'P2', 'P1', 'C', 'I2', 'I1', 'I1', 'I2', 'C', 'P1', 'P2', 'M1', 'M2', 'M3'] as $p)
                ...
                <td style="border: 1px solid #000;">{{ getGigi($resmcu['matrix_bawah'] ?? '', $p, $occ_map_b[$p]) }}</td>
            @endforeach
        </tr>
    </table>
    ...
    <table style="width: 100%; border: 1px solid #000; border-collapse: collapse; margin-bottom: 20px;">
        <tr>
            ...
            <td style="border: 1px solid #000; padding: 4px; width: 25%;">: {{ $resmcu['sya_lassaque'] ?? 'Normal' }}
            </td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td colspan="3" style="border: 1px solid #000; padding: 4px;">: {{ $resmcu['sya_parese'] ?? 'Normal' }}</td>
        </tr>
    </table>
