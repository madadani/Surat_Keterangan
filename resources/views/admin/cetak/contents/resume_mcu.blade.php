...
<div class="paper">
    <div class="content" style="font-family: Arial, sans-serif; font-size: 11pt;">
        <h3 style="margin-top: 10px;">III. PEMERIKSAAN FISIK</h3>
        ...
        <table style="width: 100%; border: 1px solid #000; border-collapse: collapse; margin-bottom: 15px;">
            <tr>
                ...
                <td style="border: 1px solid #000; padding: 4px; width: 30%;">: {{ $resmcu['systolic'] ?? '-' }} mmHg
                </td>
                <td style="border: 1px solid #000; padding: 4px; width: 20%;">Diastolic</td>
                <td style="border: 1px solid #000; padding: 4px; width: 30%;">: {{ $resmcu['diastolic'] ?? '-' }} mmHg
                </td>
            </tr>
            <tr>
        ...
        <table style="width: 100%; border: 1px solid #000; border-collapse: collapse; margin-bottom: 15px;">
            <tr>
                ...
                <td style="border: 1px solid #000; padding: 4px; width: 25%;">: {{ $resmcu['visus_od_tanpa'] ?? '-' }}
                </td>
                <td style="border: 1px solid #000; padding: 4px; width: 25%;">OD dengan kacamata</td>
                <td style="border: 1px solid #000; padding: 4px; width: 25%;">: {{ $resmcu['visus_od_dengan'] ?? '-' }}
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td colspan="3" style="border: 1px solid #000; padding: 4px;">: {{ $resmcu['buta_warna'] ?? 'Tidak' }}
                </td>
            </tr>
        </table>
        ...
        <table style="width: 100%; border: 1px solid #000; border-collapse: collapse; margin-bottom: 15px;">
            ...
            @foreach($sup_pairs as $pair)
                ...
                <tr>
                    ...
                    <td style="border: 1px solid #000; padding: 4px; width: 30%;">: {{ $resmcu['sup_' . $k1] ?? 'Normal' }}
                    </td>
                    <td style="border: 1px solid #000; padding: 4px; width: 20%;">{{ $v2 }}</td>
                    <td style="border: 1px solid #000; padding: 4px; width: 30%;">: {{ $resmcu['sup_' . $k2] ?? 'Normal' }}
                    </td>
                </tr>
            @endforeach
        </table>
    ...
    <div class="content" style="font-family: Arial, sans-serif; font-size: 11pt;">
        ...
        <table style="width: 100%; border: 1px solid #000; border-collapse: collapse; margin-bottom: 20px;">
            ...
            <tr>
                ...
                <td colspan="3" style="border: 1px solid #000; padding: 4px;">: {{ $resmcu['sya_parese'] ?? 'Normal' }}
                </td>
            </tr>
        </table>
        ...
        <h3 style="margin-top: 30px;">IV. PEMERIKSAAN PENUNJANG</h3>
